...
// Get the source folders from deployment group

///////////////////////////////////////////////

// Create control file with source folders
...
// Check if folder properties are both empty.  In this case, pull folder list from destination environment
if (!folder)
{
